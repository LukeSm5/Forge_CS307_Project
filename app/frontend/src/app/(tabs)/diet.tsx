  ...
  return (
    <View style={styles.chipGroup}>
      {tags.spiceLevel ? (
        ...
        >
          <Text
            style={[styles.chipText, { color: SPICE_COLOR[tags.spiceLevel] }]}
          >
      ...
      {tags.goal ? (
        <View
          style={[
            styles.chip,
            { backgroundColor: colorWithAlpha(GOAL_COLOR[tags.goal], "22") },
          ]}
        >
      ...
      {tags.complexity ? (
        <View
          style={[
            ...
            {
              backgroundColor: colorWithAlpha(
                COMPLEXITY_COLOR[tags.complexity],
                "22",
              ),
            },
          ]}
        >
          <Text
            style={[
              styles.chipText,
              { color: COMPLEXITY_COLOR[tags.complexity] },
            ]}
          >
      ...
      {tags.cuisine ? (
        <View style={[styles.chip, { backgroundColor: "#20242c" }]}>
          <Text style={[styles.chipText, { color: "#d1d5db" }]}>
            {formatLabel(tags.cuisine)}
          </Text>
        </View>
      ) : null}
      ...
      {tags.prepTime ? (
        <View
          style={[
            styles.chip,
            {
              backgroundColor: colorWithAlpha(TIME_COLOR[tags.prepTime], "20"),
            },
          ]}
        >
      ...
      {tags.cookTime ? (
        <View
          style={[
            styles.chip,
            {
              backgroundColor: colorWithAlpha(TIME_COLOR[tags.cookTime], "20"),
            },
          ]}
        >
      ...
      {tags.dietary.map((d) => (
        <View key={d} style={[styles.chip, { backgroundColor: "#1d2330" }]}>
          <Text style={[styles.chipText, { color: "#f5c56b" }]}>
            {formatLabel(d)}
          </Text>
        </View>
      ))}
...
function MacroBadge({
  ...
  return (
    <View
      style={[
        styles.macroBadge,
        { backgroundColor: colorWithAlpha(color, "14") },
      ]}
    >
...
function BrowseMealCard({
  ...
  const hasMacros =
    m &&
    MACRO_DISPLAY.some(({ key }) => m[key] !== null && m[key] !== undefined);
  ...
  return (
    <View
      style={[
        styles.mealCard,
        expanded && { borderColor: C?.orange ?? "#f97316" },
      ]}
    >
      ...
      <View style={styles.chipGroup}>
        {t.spiceLevel ? (
          ...
          >
            <Text
              style={[styles.chipText, { color: SPICE_COLOR[t.spiceLevel] }]}
            >
        ...
        {t.goal ? (
          <View
            style={[
              styles.chip,
              { backgroundColor: colorWithAlpha(GOAL_COLOR[t.goal], "22") },
            ]}
          >
        ...
        {t.complexity ? (
          ...
          >
            <Text
              style={[
                styles.chipText,
                { color: COMPLEXITY_COLOR[t.complexity] },
              ]}
            >
        ...
        <>
          <View style={styles.chipGroup}>
            {t.cuisine ? (
              ...
              >
                <Text
                  style={[styles.chipText, { color: C?.muted ?? "#6b7280" }]}
                >
                  {formatLabel(t.cuisine)}
                </Text>
              </View>
            ) : null}
            {t.prepTime ? (
              ...
              >
                <Text
                  style={[styles.chipText, { color: TIME_COLOR[t.prepTime] }]}
                >
            ...
            {t.cookTime ? (
              ...
              >
                <Text
                  style={[styles.chipText, { color: TIME_COLOR[t.cookTime] }]}
                >
            ...
            {hasIngredients ? (
              ...
              >
                <Text
                  style={[styles.chipText, { color: C?.orange ?? "#f97316" }]}
                >
          ...
          {t.dietary.length > 0 && (
            <View
              style={[
                ...
                {
                  borderTopWidth: 1,
                  borderTopColor: C?.border ?? "#e2e8f0",
                  paddingTop: 8,
                },
              ]}
            >
              {t.dietary.map((d) => (
                <View
                  key={d}
                  style={[styles.chip, { backgroundColor: "#1d2330" }]}
                >
                  <Text
                    style={[styles.chipText, { color: C?.muted ?? "#6b7280" }]}
                  >
      ...
      {expanded && (
        <View
          style={{
            borderTopWidth: 1,
            borderTopColor: colorWithAlpha(C?.orange ?? "#f97316", "30"),
            paddingTop: 12,
            gap: 14,
          }}
        >
          ...
          <View style={{ gap: 8 }}>
            <Text style={styles.browseExpandHeading}>
              Ingredients{" "}
              {hasIngredients ? `(${meal.ingredients!.length})` : ""}
            </Text>
            {hasIngredients ? (
              <View
                style={{
                  backgroundColor: colorWithAlpha(C?.border ?? "#e2e8f0", "20"),
                  borderRadius: 6,
                  padding: 10,
                  gap: 4,
                }}
              >
                {meal.ingredients!.map((ing) => {
                  const unitLabel =
                    INGREDIENT_UNITS.find((u) => u.value === ing.unit)?.label ??
                    ing.unit;
                  const showQty =
                    ing.unit !== "to_taste" && ing.quantity !== null;
                  return (
                    <View
                      key={ing.id}
                      style={{
      ...
      >
        <Text
          style={[
            ...
            isActive && { color: C?.orange ?? "#f97316" },
          ]}
        >
          {label}
        </Text>
        ...
        <Text style={{ fontSize: 8, color: C?.muted ?? "#6b7280" }}>
          {isOpen ? "▴" : "▾"}
        </Text>
      </Pressable>
      {isOpen && (
    ...
    <View style={styles.ingredientRow}>
      ...
      <View style={{ width: 70 }}>
        ...
        <TextInput
          ...
          onChangeText={(val) => {
            ...
            onUpdate({
              ...ingredient,
              quantity: parsed === null || isNaN(parsed) ? null : parsed,
            });
          }}
          placeholder="—"
          placeholderTextColor="#6b7280"
          style={[
            styles.rangeInput,
            { paddingVertical: 5, paddingHorizontal: 7, fontSize: 13 },
          ]}
        />
      </View>
      <View style={{ flex: 1, minWidth: 80 }}>
        ...
        <TextInput
          ...
          style={[
            styles.rangeInput,
            { paddingVertical: 5, paddingHorizontal: 7, fontSize: 12 },
          ]}
        />
      </View>
...
function TrackerRing({
  ...
  const ringColor =
    met === null ? FORGE.trackEmpty : met ? FORGE.orange : FORGE.red;
  const statusColor =
    met === null ? FORGE.steel : met ? FORGE.orangeGlow : FORGE.red;
  ...
  return (
    ...
    >
        ...
        {hasGoal ? (
          <>
            ...
            <View style={trackerStyles.barTrack}>
              <View
                style={[
                  trackerStyles.barFill,
                  { flex: Math.min(pct, 1), backgroundColor: ringColor },
                ]}
              />
      ...
      <Text style={[trackerStyles.ringStatus, { color: statusColor }]}>
        {statusText(t)}
      </Text>
      ...
      {hasGoal ? (
        <View style={trackerStyles.cfgRow}>
          ...
          <Pressable
            onPress={() => onSetGoal(t.id, null)}
            style={trackerStyles.clearGoalBtn}
          >
        ...
        <Pressable
          onPress={() => {
            setInputVal("");
            setOverlayMode("set-goal");
          }}
          style={trackerStyles.setGoalBtn}
        >
          <Text
            style={{
              color: FORGE.orange,
      ...
      <View style={trackerStyles.dirToggle}>
        {(["under", "over"] as GoalDirection[]).map((dir) => (
          <Pressable
            ...
            style={[
              trackerStyles.dirBtn,
              t.direction === dir && trackerStyles.dirBtnActive,
            ]}
          >
            <Text
              style={[
        ...
        <View style={trackerStyles.overlay}>
          ...
          <View style={{ flexDirection: "row", gap: 6 }}>
            <Pressable
              ...
              style={trackerStyles.ovBtn}
            >
              <Text style={{ color: FORGE.steel, fontSize: 11 }}>Cancel</Text>
            </Pressable>
            <Pressable
              onPress={handleConfirm}
              style={[trackerStyles.ovBtn, trackerStyles.ovBtnConfirm]}
            >
              <Text
                style={{
                  color: FORGE.charcoal,
                  fontSize: 11,
                  fontWeight: "500",
                }}
              >
...
export default function Diet() {
  ...
  /* ─── browse filter state ─── */
  const [browseFilter, setBrowseFilter] =
    useState<BrowseFilterState>(EMPTY_BROWSE_FILTER);
  const [browseOpenSection, setBrowseOpenSection] = useState<string | null>(
    null,
  );
  ...
  const [myMealFilter, setMyMealFilter] = useState<"at_home" | "restaurant">(
    "restaurant",
  );
  ...
  const [selectedMenuMeal, setSelectedMenuMeal] =
    useState<RestaurantMeal | null>(null);
  ...
  const [selectedMealType, setSelectedMealType] =
    useState<MealTypeOption | null>(null);
  ...
  /* ─── tag helpers ─── */
  const setSingleTag = <K extends keyof MealTagSet>(
    key: K,
    value: MealTagSet[K],
  ) => {
    setTags((current) => ({
  ...
  const filteredIngredients = useMemo(() => {
    ...
    if (ingredientCat)
      items = items.filter((i) => i.category === ingredientCat);
  ...
  const toggleBrowseFilter = <
    K extends keyof Omit<BrowseFilterState, "dietary" | MacroFilterKey>,
  >(
    key: K,
  ...
  const setBrowseMacroRange = (
    ...
    setBrowseFilter((f) => ({
      ...
      [key]: {
        ...(f[key] as MacroRange),
        [bound]: parsed === null || isNaN(parsed) ? null : parsed,
      },
    }));
  };
  ...
  const filteredMeals = useMemo(() => {
    return savedMeals.filter((meal) => {
      const t = meal.tags;
      if (browseFilter.spiceLevel && t.spiceLevel !== browseFilter.spiceLevel)
        return false;
      if (browseFilter.cuisine && t.cuisine !== browseFilter.cuisine)
        return false;
      if (browseFilter.complexity && t.complexity !== browseFilter.complexity)
        return false;
      if (browseFilter.goal && t.goal !== browseFilter.goal) return false;
      if (browseFilter.prepTime && t.prepTime !== browseFilter.prepTime)
        return false;
      if (browseFilter.cookTime && t.cookTime !== browseFilter.cookTime)
        return false;
      if (
        browseFilter.dietary.length > 0 &&
        !browseFilter.dietary.every((d) => t.dietary.includes(d))
      )
        return false;
  ...
  const browseTagActiveCount =
    [
      browseFilter.spiceLevel,
      browseFilter.cuisine,
      browseFilter.complexity,
      browseFilter.goal,
      browseFilter.prepTime,
      browseFilter.cookTime,
    ].filter(Boolean).length + browseFilter.dietary.length;
  const browseMacroActiveCount = MACRO_FILTER_FIELDS.filter(({ key }) =>
    macroRangeActive(key),
  ).length;
  ...
  const consumedCalories = useMemo(() => {
    return Math.round(
      loggedMenuMeals.reduce((sum, meal) => sum + (meal.energy_kcal ?? 0), 0),
    );
  }, [loggedMenuMeals]);
  ...
  const handleConfirmMealType = async () => {
    if (!selectedMenuMeal || !selectedMealType) {
      Alert.alert(
        "Select meal type",
        "Please choose breakfast, lunch, dinner, or snack.",
      );
      return;
    }
    ...
    setLoggingMeal(true);
    try {
      const created = await api.logMenuMeal(
        selectedMenuMeal.id,
        selectedMealType,
      );
    ...
    try {
      ...
      const message =
        error instanceof Error
          ? error.message
          : "Failed to recalibrate calorie goal.";
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        ...
        {myMealFilter === "restaurant" &&
          (loggedMealsLoading ? (
            ...
            <Text style={styles.emptyText}>
              No restaurant meals logged yet.
            </Text>
          ) : (
                ...
                <View key={item.session_id} style={styles.myMealRow}>
                  <View style={styles.myMealHeader}>
                    <View style={styles.restaurantMealInfo}>
                      <Text style={styles.restaurantMealName}>
                        {item.product}
                      </Text>
                  ...
                  >
                    {[
                      ...
                      {
                        label: "Carbs",
                        value: `${item.carbohydrates_g ?? 0}g`,
                      },
                      { label: "Fat", value: `${item.total_fat_g ?? 0}g` },
                      {
                        label: "Sat Fat",
                        value: `${item.saturated_fat_g ?? 0}g`,
                      },
                      {
                        label: "Trans Fat",
                        value: `${item.trans_fat_g ?? 0}g`,
                      },
                      ...
                      {
                        label: "Cholesterol",
                        value: `${item.cholesterol_mg ?? 0}mg`,
                      },
                    ].map((nutrient) => (
                      <View key={nutrient.label} style={styles.nutritionChip}>
                        <Text style={styles.nutritionChipLabel}>
                          {nutrient.label}
                        </Text>
      ...
      <SectionCard
        title={editing ? "Meal Tagging · Edit Meal" : "Meal Tagging · Add Meal"}
      >
        ...
        <View style={styles.tabRow}>
          <Pressable
            onPress={() => setTagTab("tags")}
            style={[styles.tabBtn, tagTab === "tags" && styles.tabBtnActive]}
          >
            <Text
              style={[
                styles.tabBtnText,
                tagTab === "tags" && styles.tabBtnTextActive,
              ]}
            >
              🏷 Tags & Macros
            </Text>
          ...
          <Pressable
            onPress={() => setTagTab("ingredients")}
            style={[
              styles.tabBtn,
              tagTab === "ingredients" && styles.tabBtnActive,
            ]}
          >
            <Text
              style={[
                styles.tabBtnText,
                tagTab === "ingredients" && styles.tabBtnTextActive,
              ]}
            >
              🥘 Ingredients{" "}
            ...
            <View style={{ gap: 10 }}>
              {MACRO_FIELDS.map(({ key, label, unit, placeholder }) => (
                <View key={key}>
                  ...
                  <TextInput
                    keyboardType="numeric"
                    value={macros[key] != null ? String(macros[key]) : ""}
                    onChangeText={(val) => setMacro(key, val)}
            ...
            {macros.calories != null && (
              <View style={{ gap: 4 }}>
                ...
                >
                  <View
                    style={{
                      flex: Math.min(macros.calories / 800, 1),
                      height: 4,
                      backgroundColor:
                        macros.calories > 600
                          ? "#ef4444"
                  ...
                  />
                  <View
                    style={{ flex: Math.max(1 - macros.calories / 800, 0) }}
                  />
                </View>
              </View>
            )}
          ...
          <View style={{ gap: 14 }}>
            ...
            <View style={styles.rowGap}>
              ...
              <Pressable
                onPress={() => {
                  ...
                  if (trimmed) addIngredient(trimmed, "g");
                }}
                style={[
                  styles.pill,
                  {
                    borderColor: C?.orange ?? "#f97316",
                    backgroundColor: colorWithAlpha(
                      C?.orange ?? "#f97316",
                      "18",
                    ),
              ...
              >
                <Text
                  style={[styles.pillText, { color: C?.orange ?? "#f97316" }]}
                >
                  + Custom
                </Text>
              </Pressable>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={[styles.pillWrap, { paddingRight: 10 }]}>
                <Pill
                  label="All"
                  active={!ingredientCat}
                  color={C?.orange ?? "#f97316"}
                  onPress={() => setIngredientCat(null)}
                />
                {INGREDIENT_CATEGORIES.map((cat) => (
                  <Pill
                    key={cat}
                    label={cat}
                    active={ingredientCat === cat}
                    color={C?.orange ?? "#f97316"}
                    onPress={() =>
                      setIngredientCat(ingredientCat === cat ? null : cat)
                    }
                  />
                ))}
              </View>
              ...
              >
                <ScrollView nestedScrollEnabled>
                  {filteredIngredients.length === 0 ? (
                    ...
                    >
                      No matches. Press + Custom to add "
                    ...
                    filteredIngredients.slice(0, 20).map((item) => (
                      <Pressable
                        key={item.name}
                        onPress={() =>
                          addIngredient(item.name, item.defaultUnit)
                        }
                        style={({ pressed }) => [
                          {
                            flexDirection: "row",
                      ...
                      >
                        ...
                        >
                          {INGREDIENT_UNITS.find(
                            (u) => u.value === item.defaultUnit,
                          )?.label ?? item.defaultUnit}
                        </Text>
                      </Pressable>
                    ))
                  )}
            ...
            {ingredients.length === 0 ? (
              ...
              >
                <Text style={[styles.emptyText, { textAlign: "center" }]}>
                  ...
                  <Text style={{ fontSize: 12, color: C?.muted ?? "#6b7280" }}>
        ...
        <View style={styles.rowGap}>
          ...
          <View style={[styles.flex1, editing ? styles.flex2 : undefined]}>
            <ForgeButton
              ...
              text={editing ? "Update Meal" : "Save Meal"}
            />
          </View>
        </View>
      </SectionCard>
      ...
      <SectionCard
        title={`Meal Browser${browseActiveCount ? ` · ${browseActiveCount} Active Filters` : ""}`}
      >
        <FilterSection
          title="Spice"
          values={SPICE_LEVELS}
          activeValue={browseFilter.spiceLevel}
          colorFor={(v) => SPICE_COLOR[v as SpiceLevel]}
          onPress={(v) => toggleBrowseFilter("spiceLevel", v as SpiceLevel)}
        />
        <FilterSection
          title="Cuisine"
          values={CUISINES}
          activeValue={browseFilter.cuisine}
          colorFor={() => C?.amber ?? "#f5c56b"}
          onPress={(v) => toggleBrowseFilter("cuisine", v as Cuisine)}
        />
        <FilterSection
          title="Complexity"
          values={COMPLEXITIES}
          activeValue={browseFilter.complexity}
          colorFor={(v) => COMPLEXITY_COLOR[v as Complexity]}
          onPress={(v) => toggleBrowseFilter("complexity", v as Complexity)}
        />
        <FilterSection
          title="Goal"
          values={GOALS}
          activeValue={browseFilter.goal}
          colorFor={(v) => GOAL_COLOR[v as Goal]}
          onPress={(v) => toggleBrowseFilter("goal", v as Goal)}
        />
        <FilterSection
          title="Prep Time"
          values={TIME_LABELS}
          activeValue={browseFilter.prepTime}
          colorFor={(v) => TIME_COLOR[v as TimeLabel]}
          onPress={(v) => toggleBrowseFilter("prepTime", v as TimeLabel)}
        />
        <FilterSection
          title="Cook Time"
          values={TIME_LABELS}
          activeValue={browseFilter.cookTime}
          colorFor={(v) => TIME_COLOR[v as TimeLabel]}
          onPress={(v) => toggleBrowseFilter("cookTime", v as TimeLabel)}
        />
          ...
          <View style={styles.pillWrap}>
            {DIETARY_OPTS.map((value: Dietary) => (
              <Pill
                key={value}
                label={value}
                active={browseFilter.dietary.includes(value)}
                color={C?.amber ?? "#f5c56b"}
                onPress={() => toggleBrowseDietary(value)}
              />
            ))}
          </View>
        </View>
        ...
        <View style={styles.filterBlock}>
          ...
          {MACRO_FILTER_FIELDS.map(({ key, label, unit }) => (
            <MacroRangeFilterRow
              ...
              label={label}
              unit={unit}
              range={browseFilter[key] as MacroRange}
              isOpen={browseOpenSection === `macro_${key}`}
              isActive={macroRangeActive(key)}
              onToggleOpen={() =>
                setBrowseOpenSection(
                  browseOpenSection === `macro_${key}` ? null : `macro_${key}`,
                )
              }
              onChangeMin={(val) => setBrowseMacroRange(key, "min", val)}
              onChangeMax={(val) => setBrowseMacroRange(key, "max", val)}
            />
          ))}
        </View>
      ...
      <SectionCard title="Menu Meal Search">
        ...
        <View
          style={
            filteredRestaurantMeals.length ? styles.restaurantList : undefined
          }
        >
      ...
      >
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            {(
              ["breakfast", "lunch", "dinner", "snack"] as MealTypeOption[]
            ).map((option) => {
...
const styles = StyleSheet.create({
  ...
  tabRow: {
    flexDirection: "row",
    gap: 6,
    backgroundColor: colorWithAlpha(C?.border ?? "#e2e8f0", "40"),
    borderRadius: 6,
    padding: 4,
  },
  tabBtn: {
...
const trackerStyles = StyleSheet.create({
  ...
  card: {
    flex: 1,
    minWidth: 70,
    backgroundColor: FORGE.cardBg,
    borderWidth: 1,
    borderColor: FORGE.cardBorder,
    borderRadius: 10,
    paddingTop: 16,
    paddingBottom: 12,
    paddingHorizontal: 6,
  ...
  swapBtn: {
    ...
    borderWidth: 1,
    borderColor: FORGE.cardBorder,
    backgroundColor: FORGE.charcoal,
    alignItems: "center",
    justifyContent: "center",
  },
  barWrap: {
  ...
  barTrack: {
    width: "100%",
    height: 6,
    backgroundColor: FORGE.trackEmpty,
    borderRadius: 3,
    flexDirection: "row",
    overflow: "hidden",
  },
