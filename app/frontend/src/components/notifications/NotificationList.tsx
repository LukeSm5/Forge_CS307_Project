import { ScrollView, StyleProp, StyleSheet, TextInput, TouchableOpacity, ViewStyle } from 'react-native';
...
export default function NotificationList({ notifications, style }: { notifications: Notification[], style?: StyleProp<ViewStyle> }) {
    const s = useScheme();

    return (<>
        <ScrollView style={[ styles.searchResults, { boxShadow: `inset 3px 3px 10px ${s.shadow}` }, style ]}>
            {notifications
